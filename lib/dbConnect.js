...
async function updateElection(data) {
    const id = data.id;
    const n = data.name;
    const type = data.type;
...
module.exports = {getCity, addStudent, updateStudent, verifyUser, verifyAdmin, addElection, getElections, getElection,updateElection, addCandidate, getStudent, getStudentElections, getCandidates, voteCandidates, getElectionStatus, registerVote, getHistory};
