...
const {getAdmin} = require('../Mongodb/adminDb.js');
...
function verifyUser(req, res, next){
    ...
    const unproctedRoutes = ['/', '/admin', '/student/register', '/logout', '/student', '/register'];
    ...
    if(!user.isAdmin){
       ...
       console.log('Is the token user thesame as the request matricule? ',user.user === matricule);
